# Adapted from https://gitlab.freedesktop.org/Per_Bothner/specifications/-/blob/master/proposals/prompts-data/shell-integration.fish
# Provides shell integrations to the terminal, allowing things like scrollback to the previous prompt
