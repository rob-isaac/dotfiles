...
set -g status-right "#[fg=#131a24,bg=#131a24,nobold,nounderscore,noitalics]#[fg=#719cd6,bg=#131a24] #{prefix_highlight} #[fg=#aeafb0,bg=#131a24,nobold,nounderscore,noitalics]#[fg=#131a24,bg=#aeafb0] CPU:#{cpu_percentage}  GPU:#{gpu_percentage}  RAM:#{ram_percentage} #[fg=#8b8c8c,bg=#aeafb0]#[fg=#131a24,bg=#8b8c8c] #{battery_icon} #{battery_percentage}  󰸗 %Y-%m-%d   %I:%M %p #[fg=#719cd6,bg=#8b8c8c,nobold,nounderscore,noitalics]#[fg=#131a24,bg=#719cd6,bold] #h "
